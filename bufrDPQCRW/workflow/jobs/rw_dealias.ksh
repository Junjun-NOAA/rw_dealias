...
# archive the data
#if [[ -e $bkrwdir/$YYYYMMDD$HH.bkrw.t${HH}z.bufr ]]; then
#   hsi mkdir -p /ESRL/BMC/wrfruc/5year/jjhu/DealiasedVelocityDPQC/$YYYYMMDD
#   htar -cvf /ESRL/BMC/wrfruc/5year/jjhu/DealiasedVelocityDPQC/$YYYYMMDD/$YYYYMMDD$HH.bkrw.t${HH}z.bufr.tar $bkrwdir/$YYYYMMDD$HH.bkrw.t${HH}z.bufr 
#fi
